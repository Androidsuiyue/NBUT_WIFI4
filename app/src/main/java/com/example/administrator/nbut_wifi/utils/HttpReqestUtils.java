...
public class HttpReqestUtils {
    ...
    public static String sendGet(String url, String param) {
        ...
        try {
            ...
            connection.setRequestProperty("Host", "10.23.4.165");
            connection.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
            connection.setRequestProperty("Origin", "http://10.23.4.165");
            connection.setRequestProperty("Content-Length", "645");
            connection.setRequestProperty("user-agent",
                    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
            connection.setRequestProperty("Content-Type", "multipart/form-data; boundary=--------1461088816");
